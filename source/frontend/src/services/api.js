...
export const orgService = {
  ...
  getDepartments: () => orgApi.get('/api/departments'),
  getDepartmentById: (id) => orgApi.get(`/api/departments/${id}`),
  createDepartment: (data) => orgApi.post('/api/departments', data),
  updateDepartment: (id, data) => orgApi.put(`/api/departments/${id}`, data),
  deleteDepartment: (id) => orgApi.delete(`/api/departments/${id}`),
